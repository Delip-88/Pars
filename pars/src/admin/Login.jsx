...
const AdminLogin = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.ok && data.success) {
        if (data.user.role === "admin") {
          ...
          toast.update(loadingToast, {
            render: "Login successful! Welcome back, Admin.",
            type: "success",
            isLoading: false,
            autoClose: 3000,
          });
          ...
          toast.update(loadingToast, {
            render: "Access denied. Admins only.",
            type: "error",
            isLoading: false,
            autoClose: 3000,
          });
        ...
        toast.update(loadingToast, {
          render: data.message || "Invalid credentials. Please try again.",
          type: "error",
          isLoading: false,
          autoClose: 3000,
        });
      ...
      toast.update(loadingToast, {
        render: "Login failed. Please check your connection and try again.",
        type: "error",
        isLoading: false,
        autoClose: 3000,
      });
